...
ARTEMIS_HOME='/Users/kwall/releases/apache-artemis-2.11.0'
ARTEMIS_INSTANCE='/private/tmp/artemis'
ARTEMIS_DATA_DIR='/private/tmp/artemis/data'
ARTEMIS_ETC_DIR='/private/tmp/artemis/etc'
ARTEMIS_OOME_DUMP='/private/tmp/artemis/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/tmp/artemis/'
ARTEMIS_INSTANCE_ETC_URI='file:/tmp/artemis/etc/'
...
JAVA_ARGS=" -XX:+PrintClassHistogram -XX:+UseG1GC -Xms512M -Xmx2G -Dhawtio.realm=CertLogin -Dhawtio.offline=true -Dhawtio.role=amq -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml"
